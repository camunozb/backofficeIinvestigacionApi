...
const resolvers = {
  ...
  // Proyectos: {
  //   lider: async (parent, args, context, info) => {
  ...
  Query: {
    ...
    Usuarios: async (parent, args, context, info) => {
      console.log(args);
      const usuarios = await User.find({...args.filtro});
      return usuarios;
    },
   ...
   // getLider: async (parent, args, context, info) => getLider(arg._id),
    ...
    getProjectLider: async (parent, args, context, info) => getProjectLider(args.idUsuario),
